...
def find_a_doctor():
    ...
    with col1:
        st.markdown('<div style="margin-top: -25px;" class="title-wrapper"><h1 style="text-align: center;">Find A Doctor</h1></div>', unsafe_allow_html=True)
...
def appointment_maker():
    col1, col2,col3 = st.columns([3, 1,1])
    with col1:
        st.markdown('<div style="margin-top: -25px;" class="title-wrapper"><h1 style="text-align: center;">Appointment Maker</h1></div>', unsafe_allow_html=True)
    with col2:
        if st.button("_Back_",use_container_width=True):
            st.session_state.action = None
...
def visit_assistant():
    col1, col2,col3 = st.columns([3, 1,1])
    with col1:
        st.markdown('<div style="margin-top: -25px; " class="title-wrapper"><h1 style="text-align: center;">Visit Assistant</h1></div>', unsafe_allow_html=True)
    with col2:
        if st.button("_Back_",use_container_width=True):
            st.session_state.action = None
...
def wellness_advocate():
    col1, col2,col3 = st.columns([3, 1,1])
    with col1:
        st.markdown('<div style="margin-top: -25px; " class="title-wrapper"><h1 style="text-align: center;">Wellness Adovocate</h1></div>', unsafe_allow_html=True)
    with col2:
        if st.button("_Back_",use_container_width=True):
            st.session_state.action = None
